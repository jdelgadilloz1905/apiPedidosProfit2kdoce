...
class ModelProducts{
    ...
    static public function mdlShowProducts($item,$valor){
        ...
        if($item != null){
            $stmt = Conexion::conectar()->prepare("SELECT * from productos WHERE $item = :$item order by a.co_art desc ");
            ...
            $stmt = Conexion::conectar()->query("SELECT  * from productos  order by a.co_art desc ");
